...
lazy val chipyard = (project in file("generators/chipyard"))
  .dependsOn(testchipip, rocketchip, boom, hwacha, sifive_blocks, sifive_cache, iocell,
    sha3,
    tut_1, // On separate line to allow for cleaner tutorial-setup patches
    ascon, // On separate line to allow for cleaner tutorial-setup patches
...
lazy val ascon = (project in file("generators/ascon"))
  .dependsOn(rocketchip, midasTargetUtils)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(chiselTestSettings)
  .settings(commonSettings)
...
lazy val tut_1 = (project in file("generators/RoCC_Tutorial/simple-example"))
  .dependsOn(rocketchip, midasTargetUtils)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(commonSettings)
