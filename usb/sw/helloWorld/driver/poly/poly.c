...
void hwpoly1305_results(void* polyctrl){
  uart_put_hex((void*)uart, _REG32((char*)polyctrl, POLY_REG_MAC_0));
  uart_put_hex((void*)uart, _REG32((char*)polyctrl, POLY_REG_MAC_1));
  uart_put_hex((void*)uart, _REG32((char*)polyctrl, POLY_REG_MAC_2));
  uart_put_hex((void*)uart, _REG32((char*)polyctrl, POLY_REG_MAC_3));
  uart_puts((void*)uart,"\n");
}
...
void hwpoly1305_debug(void* polyctrl){
  for(int i = 0; i < 4; i++) {
  uart_put_hex((void*)uart, _REG32((char*)polyctrl, POLY_REG_BLOCK_0+i*4));  
  } 
  uart_puts((void*)uart,"\n");
}
