...
void hwchacha20_results(void* chachactrl){
    kprintf("Results:\n");
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_0));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_1));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_2));
    kprintf("%x\n",_REG32((char*)chachactrl, CHACHA_REG_OUT_3));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_4));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_5));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_6));
    kprintf("%x\n",_REG32((char*)chachactrl, CHACHA_REG_OUT_7));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_8));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_9));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_10));
    kprintf("%x\n",_REG32((char*)chachactrl, CHACHA_REG_OUT_11));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_12));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_13));
    kprintf("%x",_REG32((char*)chachactrl, CHACHA_REG_OUT_14));
