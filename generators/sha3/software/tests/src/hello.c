...
int main(int argc, char **arv) {
  ...
  printf("Hello world from core %c!!!\r\n", mhartid + 48);

  #ifdef TRNG_TEST
  printf("TRNG testing software\n");
  int status = 0;
  uint32_t rand = 0;
  uint32_t numbers = 10;
  printf("Setup TRNG...\n");
  ...
  printf("CHACHA testing software\n");
  uintptr_t chachactrl= 0x64006000;
  printf("Begin CHACHA20 hardware test:\r\n\n\n");
  ...
  #ifdef POLY_TEST
  printf("POLY testing software\n");
  uintptr_t poly_reg= 0x64007000;

  // Keys Test Software
  const uint8_t   key_poly[32] = {0x85, 0xd6, 0xbe, 0x78, 0x57, 0x55, 0x6d, 0x33,
  ...
  printf("Begin POLY1305 hardware test:\r\n");
  printf("\n\n");

  // Software Poly1305
  printf("Software: ");

  poly1305_tag(key_poly,block,block_len,mac);
  ...
  #ifdef X25519_TEST
    printf("X25519_TEST testing software\n");
    uintptr_t x25519_reg= 0x64004000;

    // Hardware x25519
    // -------------

    printf("Hardware \n");
    hwx25519_selftest((void*)x25519_reg);
  #endif //X25519_TEST

  #ifdef AESGCM_TEST
    printf("AES testing software\n");
    uintptr_t aes_gcm_reg= 0x64009000;
  //  hwaesgcm_selftest((void*)aes_gcm_reg);
   hwaesgcm_testcase2_aes128((void*)aes_gcm_reg);
    // hwaesgcm_1m_selftest((void*)aes_gcm_reg);
  #endif //AESGCM_TEST

  #ifdef HMAC_SHA_TEST
    printf("HMAC_SHA testing software\n");
